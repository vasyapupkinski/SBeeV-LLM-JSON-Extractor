...
TRAIN_PATH = PROJECT_ROOT / "data" / "splits_v2" / "train_augmented.jsonl"
VAL_PATH = PROJECT_ROOT / "data" / "splits_v2" / "val.jsonl"
...
def main():
    ...
    training_args = SFTConfig(
        output_dir=str(PROJECT_ROOT / "models" / "sbv-dora-adapter-v2"),
    ...
    # 5. 어댑터 저장
    output_dir = PROJECT_ROOT / "models" / "sbv-dora-adapter-v2"
