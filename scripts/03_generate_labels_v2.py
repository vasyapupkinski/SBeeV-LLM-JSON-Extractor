...
OUTPUT_PATH = PROJECT_ROOT / "data" / "labeled" / "labeled_dataset_v2.jsonl"
CHECKPOINT_PATH = PROJECT_ROOT / "data" / "labeled" / "label_checkpoint_v2.json"
...
- deadline: 마감일 (예: "2026-12-31", "상시채용")
